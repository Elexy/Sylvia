 ...
 * shiplist.php
 *
 * @version $Id: products_sold.php,v 1.1 2005-08-09 07:12:02 alex Exp $
 * @copyright $date:
 **/
...
if (mysql_num_rows($openorderdetails_query)) {        
    ...
    while ($obj_opendet = mysql_fetch_array($openorderdetails_query)) {
        echo "<tr><td align=\"center\" class=\"cellline\" WIDTH='8%'><A HREF='".orders."?orderID=".$obj_opendet["OrderID"]."'> ".$obj_opendet["OrderID"]."</A></td>\n"; 
