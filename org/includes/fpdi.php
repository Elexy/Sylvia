...
require_once($_SERVER['DOCUMENT_ROOT'].$GLOBALS["ary_config"]['file_root_path']."/includes/fpdf_tpl.php");
require_once($_SERVER['DOCUMENT_ROOT'].$GLOBALS["ary_config"]['file_root_path']."/includes/pdf_parser.php");
    ...
    function _putOobjects() {
        if (is_array($this->parsers) && count($this->parsers) > 0) {
            foreach($this->parsers AS $filename => $p) {
                ...
                if (isset($this->obj_stack) && is_array($this->obj_stack[$filename])) {
