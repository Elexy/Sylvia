...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TR>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sun</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Mon</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Tue</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Wed</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Thu</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Fri</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='16%' BGCOLOR=\"" + this.gHeaderBGColor + "\"><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sat</B></FONT></TD>";
	vCode = vCode + "</TR>";
