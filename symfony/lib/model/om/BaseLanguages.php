...
abstract class BaseLanguages extends BaseObject  implements Persistent {
  ...
  const PEER = 'LanguagesPeer';
	...
	public function setLanguageid($v)
	{
		...
		if ($this->languageid !== $v) {
			$this->languageid = $v;
			$this->modifiedColumns[] = LanguagesPeer::LANGUAGEID;
		}
	...
	public function setLanguage($v)
	{
		...
		if ($this->language !== $v || $v === '') {
			$this->language = $v;
			$this->modifiedColumns[] = LanguagesPeer::LANGUAGE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(LanguagesPeer::LANGUAGE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->languageid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = LanguagesPeer::NUM_COLUMNS - LanguagesPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseLanguages:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			LanguagesPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseLanguages:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseLanguages:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseLanguages:save:post') as $callable)
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LanguagesPeer::doInsert($this, $con);
					...
					$affectedRows += LanguagesPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LanguagesPeer::LANGUAGEID)) $criteria->add(LanguagesPeer::LANGUAGEID, $this->languageid);
		if ($this->isColumnModified(LanguagesPeer::LANGUAGE)) $criteria->add(LanguagesPeer::LANGUAGE, $this->language);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LanguagesPeer::LANGUAGEID, $this->languageid);
	...
	/**
	 * Generic method to set the primary key (languageid column).
	 *
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseLanguages:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseLanguages::%s', $method));
    }
