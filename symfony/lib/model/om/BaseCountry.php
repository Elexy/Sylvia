...
abstract class BaseCountry extends BaseObject  implements Persistent {
  ...
  const PEER = 'CountryPeer';
	...
	/**
	 * The value for the eu_country field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $eu_country;
	...
	/**
	 * The value for the zipcode_format field.
	 * @var        string
	 */
	protected $zipcode_format;
	...
	/**
	 * Get the [eu_country] column value.
	 * 
	 * @return     int
	 */
	public function getEuCountry()
	{
		return $this->eu_country;
	}
	...
	/**
	 * Get the [zipcode_format] column value.
	 * 
	 * @return     string
	 */
	public function getZipcodeFormat()
	{
		return $this->zipcode_format;
	}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v || $v === '0') {
			$this->country = $v;
			$this->modifiedColumns[] = CountryPeer::COUNTRY;
		}
	...
	/**
	 * Set the value of [eu_country] column.
	 * 
	 * @param      int $v new value
	 * @return     Country The current object (for fluent API support)
	 */
	public function setEuCountry($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->eu_country !== $v || $v === 0) {
			$this->eu_country = $v;
			$this->modifiedColumns[] = CountryPeer::EU_COUNTRY;
		}
	...
	/**
	 * Set the value of [zipcode_format] column.
	 * 
	 * @param      string $v new value
	 * @return     Country The current object (for fluent API support)
	 */
	public function setZipcodeFormat($v)
	{
		...
		if ($this->zipcode_format !== $v) {
			$this->zipcode_format = $v;
			$this->modifiedColumns[] = CountryPeer::ZIPCODE_FORMAT;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CountryPeer::CODE,CountryPeer::COUNTRY,CountryPeer::EU_COUNTRY))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->eu_country = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->iso_code = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->zipcode_format = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getEuCountry(),
			$keys[3] => $this->getIsoCode(),
			$keys[4] => $this->getZipcodeFormat(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setEuCountry($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setIsoCode($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setZipcodeFormat($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CountryPeer::EU_COUNTRY)) $criteria->add(CountryPeer::EU_COUNTRY, $this->eu_country);
		if ($this->isColumnModified(CountryPeer::ISO_CODE)) $criteria->add(CountryPeer::ISO_CODE, $this->iso_code);
		if ($this->isColumnModified(CountryPeer::ZIPCODE_FORMAT)) $criteria->add(CountryPeer::ZIPCODE_FORMAT, $this->zipcode_format);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CountryPeer::CODE, $this->code);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setEuCountry($this->eu_country);

		$copyObj->setIsoCode($this->iso_code);

		$copyObj->setZipcodeFormat($this->zipcode_format);
