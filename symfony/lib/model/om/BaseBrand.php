...
abstract class BaseBrand extends BaseObject  implements Persistent {
  ...
  const PEER = 'BrandPeer';
	...
	/**
	 * Initializes internal state of BaseBrand object.
	 * @see        applyDefaults()
	 */
	...
	public function setBrandId($v)
	{
		...
		if ($this->brand_id !== $v) {
			$this->brand_id = $v;
			$this->modifiedColumns[] = BrandPeer::BRAND_ID;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(BrandPeer::NAME))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->brand_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = BrandPeer::NUM_COLUMNS - BrandPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setBrandId($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setBrandId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BrandPeer::BRAND_ID)) $criteria->add(BrandPeer::BRAND_ID, $this->brand_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(BrandPeer::BRAND_ID, $this->brand_id);
