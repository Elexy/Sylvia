...
abstract class BasePaymentType extends BaseObject  implements Persistent {
  ...
  const PEER = 'PaymentTypePeer';
	...
	/**
	 * Initializes internal state of BasePaymentType object.
	 * @see        applyDefaults()
	 */
	...
	public function setPaymentName($v)
	{
		...
		if ($this->payment_name !== $v) {
			$this->payment_name = $v;
			$this->modifiedColumns[] = PaymentTypePeer::PAYMENT_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->payment_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = PaymentTypePeer::NUM_COLUMNS - PaymentTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setPaymentName($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PaymentTypePeer::PAYMENT_NAME)) $criteria->add(PaymentTypePeer::PAYMENT_NAME, $this->payment_name);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPaymentName($this->payment_name);
