...
abstract class BaseLocation extends BaseObject  implements Persistent {
  ...
  const PEER = 'LocationPeer';
	...
	/**
	 * The value for the walk_order field.
	 * Note: this column has a database default value of: 50
	 * @var        int
	 */
	protected $walk_order;
	...
	/**
	 * Get the [walk_order] column value.
	 * 
	 * @return     int
	 */
	public function getWalkOrder()
	{
		return $this->walk_order;
	}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v || $v === '0') {
			$this->location = $v;
			$this->modifiedColumns[] = LocationPeer::LOCATION;
		}
	...
	/**
	 * Set the value of [walk_order] column.
	 * 
	 * @param      int $v new value
	 * @return     Location The current object (for fluent API support)
	 */
	public function setWalkOrder($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->walk_order !== $v || $v === 50) {
			$this->walk_order = $v;
			$this->modifiedColumns[] = LocationPeer::WALK_ORDER;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(LocationPeer::LOCATION,LocationPeer::WALK_ORDER))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->walk_order = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setWalkOrder($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LocationPeer::LOCATION)) $criteria->add(LocationPeer::LOCATION, $this->location);
		if ($this->isColumnModified(LocationPeer::WALK_ORDER)) $criteria->add(LocationPeer::WALK_ORDER, $this->walk_order);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setWalkOrder($this->walk_order);
