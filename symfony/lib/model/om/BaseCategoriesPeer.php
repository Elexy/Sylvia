...
abstract class BaseCategoriesPeer {
	...
	const PARENTID = 'categories.PARENTID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Categoryid', 'Parentid', 'Categoryname', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('categoryid', 'parentid', 'categoryname', ),
		BasePeer::TYPE_COLNAME => array (self::CATEGORYID, self::PARENTID, self::CATEGORYNAME, ),
		BasePeer::TYPE_FIELDNAME => array ('CategoryID', 'ParentID', 'CategoryName', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Categoryid' => 0, 'Parentid' => 1, 'Categoryname' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('categoryid' => 0, 'parentid' => 1, 'categoryname' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::CATEGORYID => 0, self::PARENTID => 1, self::CATEGORYNAME => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('CategoryID' => 0, 'ParentID' => 1, 'CategoryName' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoriesPeer::CATEGORYID);

		$criteria->addSelectColumn(CategoriesPeer::PARENTID);

		$criteria->addSelectColumn(CategoriesPeer::CATEGORYNAME);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(CategoriesPeer::CATEGORYID) && $criteria->keyContainsValue(CategoriesPeer::CATEGORYID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CategoriesPeer::CATEGORYID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CategoriesPeer::CATEGORYID);
			$selectCriteria->add(CategoriesPeer::CATEGORYID, $criteria->remove(CategoriesPeer::CATEGORYID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CategoriesPeer::CATEGORYID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CategoriesPeer::CATEGORYID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CategoriesPeer::DATABASE_NAME);
			$criteria->add(CategoriesPeer::CATEGORYID, $pks, Criteria::IN);
