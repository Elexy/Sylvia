...
abstract class BaseCountryPeer {
	...
	/** the column name for the EU_COUNTRY field */
	const EU_COUNTRY = 'country.EU_COUNTRY';

	/** the column name for the ISO_CODE field */
	const ISO_CODE = 'country.ISO_CODE';

	/** the column name for the ZIPCODE_FORMAT field */
	const ZIPCODE_FORMAT = 'country.ZIPCODE_FORMAT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Code', 'Country', 'EuCountry', 'IsoCode', 'ZipcodeFormat', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('code', 'country', 'euCountry', 'isoCode', 'zipcodeFormat', ),
		BasePeer::TYPE_COLNAME => array (self::CODE, self::COUNTRY, self::EU_COUNTRY, self::ISO_CODE, self::ZIPCODE_FORMAT, ),
		BasePeer::TYPE_FIELDNAME => array ('code', 'country', 'eu_country', 'iso_code', 'zipcode_format', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Code' => 0, 'Country' => 1, 'EuCountry' => 2, 'IsoCode' => 3, 'ZipcodeFormat' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('code' => 0, 'country' => 1, 'euCountry' => 2, 'isoCode' => 3, 'zipcodeFormat' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::CODE => 0, self::COUNTRY => 1, self::EU_COUNTRY => 2, self::ISO_CODE => 3, self::ZIPCODE_FORMAT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('code' => 0, 'country' => 1, 'eu_country' => 2, 'iso_code' => 3, 'zipcode_format' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryPeer::EU_COUNTRY);

		$criteria->addSelectColumn(CountryPeer::ISO_CODE);

		$criteria->addSelectColumn(CountryPeer::ZIPCODE_FORMAT);
  ...
  {
    return array(array('code', 'country'));
  }
	/**
    ...
    foreach (sfMixer::getCallables('BaseCountryPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CountryPeer::CODE);
			$selectCriteria->add(CountryPeer::CODE, $criteria->remove(CountryPeer::CODE), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CountryPeer::CODE, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CountryPeer::CODE, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CountryPeer::DATABASE_NAME);
			$criteria->add(CountryPeer::CODE, $pks, Criteria::IN);
