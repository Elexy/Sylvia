  ...
  const PEER = 'CategoriesPeer';
	...
	public function setCategoryid($v)
	{
		...
		if ($this->categoryid !== $v) {
			$this->categoryid = $v;
			$this->modifiedColumns[] = CategoriesPeer::CATEGORYID;
		}
	...
	public function setParentid($v)
	{
		...
		if ($this->parentid !== $v || $v === 0) {
			$this->parentid = $v;
			$this->modifiedColumns[] = CategoriesPeer::PARENTID;
		}
	...
	public function setCategoryname($v)
	{
		...
		if ($this->categoryname !== $v) {
			$this->categoryname = $v;
			$this->modifiedColumns[] = CategoriesPeer::CATEGORYNAME;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CategoriesPeer::PARENTID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->categoryid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->parentid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->categoryname = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriesPeer::CATEGORYID)) $criteria->add(CategoriesPeer::CATEGORYID, $this->categoryid);
		if ($this->isColumnModified(CategoriesPeer::PARENTID)) $criteria->add(CategoriesPeer::PARENTID, $this->parentid);
		if ($this->isColumnModified(CategoriesPeer::CATEGORYNAME)) $criteria->add(CategoriesPeer::CATEGORYNAME, $this->categoryname);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CategoriesPeer::CATEGORYID, $this->categoryid);
