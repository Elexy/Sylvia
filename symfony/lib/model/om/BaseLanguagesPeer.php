...
abstract class BaseLanguagesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Languageid', 'Language', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('languageid', 'language', ),
		BasePeer::TYPE_COLNAME => array (self::LANGUAGEID, self::LANGUAGE, ),
		BasePeer::TYPE_FIELDNAME => array ('languageID', 'language', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Languageid' => 0, 'Language' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('languageid' => 0, 'language' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::LANGUAGEID => 0, self::LANGUAGE => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('languageID' => 0, 'language' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LanguagesMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LanguagesPeer::LANGUAGEID);

		$criteria->addSelectColumn(LanguagesPeer::LANGUAGE);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(LanguagesPeer::TABLE_NAME);
    ...
    foreach (sfMixer::getCallables('BaseLanguagesPeer:doCount:doCount') as $callable)
    {
	...
	{
		return LanguagesPeer::populateObjects(LanguagesPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseLanguagesPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLanguagesPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Languages $value A Languages object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Languages $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getLanguageid();
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A Languages object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Languages) {
				$key = (string) $value->getLanguageid();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Languages object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = LanguagesPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = LanguagesPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				LanguagesPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseLanguagesPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(LanguagesPeer::LANGUAGEID) && $criteria->keyContainsValue(LanguagesPeer::LANGUAGEID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.LanguagesPeer::LANGUAGEID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseLanguagesPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(LanguagesPeer::LANGUAGEID);
			$selectCriteria->add(LanguagesPeer::LANGUAGEID, $criteria->remove(LanguagesPeer::LANGUAGEID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			LanguagesPeer::clearInstancePool();

			// rename for clarity
			$criteria = clone $values;
		} elseif ($values instanceof Languages) {
			// invalidate the cache for this single object
			LanguagesPeer::removeInstanceFromPool($values);
			...
			$criteria->add(LanguagesPeer::LANGUAGEID, (array) $values, Criteria::IN);

			foreach ((array) $values as $singleval) {
				// we can invalidate the cache for this single object
				LanguagesPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = LanguagesPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(LanguagesPeer::LANGUAGEID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(LanguagesPeer::DATABASE_NAME);
			$criteria->add(LanguagesPeer::LANGUAGEID, $pks, Criteria::IN);
...
//
// NOTE: This static code cannot call methods on the LanguagesPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LanguagesPeer class:
//
// Propel::getDatabaseMap(LanguagesPeer::DATABASE_NAME)->addTableBuilder(LanguagesPeer::TABLE_NAME, LanguagesPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseLanguagesPeer::DATABASE_NAME)->addTableBuilder(BaseLanguagesPeer::TABLE_NAME, BaseLanguagesPeer::getMapBuilder());
