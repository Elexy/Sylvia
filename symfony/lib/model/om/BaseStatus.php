...
abstract class BaseStatus extends BaseObject  implements Persistent {
  ...
  const PEER = 'StatusPeer';
	...
	public function setStatusid($v)
	{
		...
		if ($this->statusid !== $v) {
			$this->statusid = $v;
			$this->modifiedColumns[] = StatusPeer::STATUSID;
		}
	...
	public function setStatustext($v)
	{
		...
		if ($this->statustext !== $v || $v === '0') {
			$this->statustext = $v;
			$this->modifiedColumns[] = StatusPeer::STATUSTEXT;
		}
	...
	public function setCategory($v)
	{
		...
		if ($this->category !== $v) {
			$this->category = $v;
			$this->modifiedColumns[] = StatusPeer::CATEGORY;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(StatusPeer::STATUSTEXT))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->statusid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->statustext = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setStatusid($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setStatusid($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setStatustext($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StatusPeer::STATUSID)) $criteria->add(StatusPeer::STATUSID, $this->statusid);
		if ($this->isColumnModified(StatusPeer::STATUSTEXT)) $criteria->add(StatusPeer::STATUSTEXT, $this->statustext);
		if ($this->isColumnModified(StatusPeer::CATEGORY)) $criteria->add(StatusPeer::CATEGORY, $this->category);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(StatusPeer::STATUSID, $this->statusid);
	...
	/**
	 * Generic method to set the primary key (statusid column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setStatustext($this->statustext);
