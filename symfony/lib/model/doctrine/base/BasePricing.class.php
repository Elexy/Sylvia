 ...
 * @method Pricing   setRecordid()       Sets the current record's "recordid" value
 * @method Pricing   setPurchasePrice()  Sets the current record's "purchase_price" value
 * @method Pricing   setAmount()         Sets the current record's "amount" value
 * @method Pricing   setCurrencyid()     Sets the current record's "currencyid" value
 * @method Pricing   setStartDate()      Sets the current record's "start_date" value
 * @method Pricing   setEndDate()        Sets the current record's "end_date" value
 * @method Pricing   setCreated()        Sets the current record's "created" value
 * @method Pricing   setCreatedBy()      Sets the current record's "created_by" value
 * @method Pricing   setContactid()      Sets the current record's "contactid" value
 * @method Pricing   setProductid()      Sets the current record's "productid" value
 * @method Pricing   setPriceType()      Sets the current record's "price_type" value
 * @method Pricing   setStartNumber()    Sets the current record's "start_number" value
 * @method Pricing   setEndNumber()      Sets the current record's "end_number" value
 * @method Pricing   setUpdatedAt()      Sets the current record's "updated_at" value
 * @method Pricing   setUpdatedAtBy()    Sets the current record's "updated_at_by" value
 * 
 * @package    andrea
 * @subpackage model
